...
export const MessageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipster-socket-io-chat-example2App.message.delete.question">
        <Translate contentKey="jhipster-socket-io-chat-example2App.message.delete.question" interpolate={{ id: messageEntity.id }}>
